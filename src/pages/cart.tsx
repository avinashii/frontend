...
import { addToCart, calculatePrice, discountApplied, removeCartItem } from "../redux/reducer/cart-reducer";
...
const Cart = () => {
  ...
  const {cartItems , subtotal, total,tax, shippingCharges,discount}= useSelector(
